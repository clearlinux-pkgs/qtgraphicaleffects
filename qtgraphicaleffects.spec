...
Source0  : https://download.qt.io/official_releases/qt/5.13/5.13.1/submodules/qtgraphicaleffects-everywhere-src-5.13.1.tar.xz
...
%prep
%setup -q -n qtgraphicaleffects-everywhere-src-5.13.1
...
%install
export SOURCE_DATE_EPOCH=1568396942
rm -rf %{buildroot}
