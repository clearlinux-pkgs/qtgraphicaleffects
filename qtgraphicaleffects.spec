...
Version  : 5.12.3
Release  : 17
URL      : https://download.qt.io/official_releases/qt/5.12/5.12.3/submodules/qtgraphicaleffects-everywhere-src-5.12.3.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.3/submodules/qtgraphicaleffects-everywhere-src-5.12.3.tar.xz
...
%prep
%setup -q -n qtgraphicaleffects-everywhere-src-5.12.3
...
%install
export SOURCE_DATE_EPOCH=1556925048
rm -rf %{buildroot}
