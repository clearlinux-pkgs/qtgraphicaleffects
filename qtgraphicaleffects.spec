...
Version  : 5.12.1
Release  : 15
URL      : https://download.qt.io/official_releases/qt/5.12/5.12.1/submodules/qtgraphicaleffects-everywhere-src-5.12.1.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.1/submodules/qtgraphicaleffects-everywhere-src-5.12.1.tar.xz
...
%prep
%setup -q -n qtgraphicaleffects-everywhere-src-5.12.1
...
%install
export SOURCE_DATE_EPOCH=1549043903
rm -rf %{buildroot}
