...
Source0  : https://download.qt.io/official_releases/qt/5.14/5.14.2/submodules/qtgraphicaleffects-everywhere-src-5.14.2.tar.xz
...
%prep
%setup -q -n qtgraphicaleffects-everywhere-src-5.14.2
cd %{_builddir}/qtgraphicaleffects-everywhere-src-5.14.2
...
%install
export SOURCE_DATE_EPOCH=1586207252
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/qtgraphicaleffects
cp %{_builddir}/qtgraphicaleffects-everywhere-src-5.14.2/LICENSE.FDL %{buildroot}/usr/share/package-licenses/qtgraphicaleffects/61907422fefcd2313a9b570c31d203a6dbebd333
cp %{_builddir}/qtgraphicaleffects-everywhere-src-5.14.2/LICENSE.GPL2 %{buildroot}/usr/share/package-licenses/qtgraphicaleffects/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/qtgraphicaleffects-everywhere-src-5.14.2/LICENSE.GPL3 %{buildroot}/usr/share/package-licenses/qtgraphicaleffects/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/qtgraphicaleffects-everywhere-src-5.14.2/LICENSE.GPL3-EXCEPT %{buildroot}/usr/share/package-licenses/qtgraphicaleffects/e93757aefa405f2c9a8a55e780ae9c39542dfc3a
cp %{_builddir}/qtgraphicaleffects-everywhere-src-5.14.2/LICENSE.LGPL3 %{buildroot}/usr/share/package-licenses/qtgraphicaleffects/f45ee1c765646813b442ca58de72e20a64a7ddba
%make_install
